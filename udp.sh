...
iptables -t nat -A PREROUTING -i "$IFACE" -p udp --dport 53 -j DNAT --to-destination :5667
iptables -t nat -A PREROUTING -i "$IFACE" -p udp --dport 123 -j DNAT --to-destination :5667
